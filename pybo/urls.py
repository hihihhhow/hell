...
urlpatterns = [
    ...
    path('comment/modify/question/<int:answer_id>/', comment_views.comment_modify_question, name='comment_modify_answer'),
    path('comment/delete/question/<int:answer_id>/', comment_views.comment_delete_question, name='comment_delete_answer'),
